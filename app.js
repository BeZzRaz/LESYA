...
vk.setOptions({ token: '8df3142afa4b3fe4f22bd18e276a964f79bcad764bc71759c7dc39fb2b6995d4197fe36aff58abe9bafc5', pollingGroupId: 196699555 });
const { updates, snippets } = vk;

updates.startPolling();
updates.on('message', async (message) => {
	if(Number(message.senderId) <= 0) return;
	if(/\[196699555\|(.*)\]/i.test(message.text)) message.text = message.text.replace(/\[196699555\|(.*)\]/ig, '').trim();
